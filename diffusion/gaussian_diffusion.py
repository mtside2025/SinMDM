...
from data_utils.humanml.scripts import motion_process
...
class GaussianDiffusion:
    ...
    def to(self, device):
        """ move internal modules (e.g., losses) to a device """
        for mod in dir(self):
            mod = eval('self.' + mod)
    ...
    def non_masked_l2(self, a, b):
        mse_loss_val = mean_flat(self.l2_loss(a, b))
        return mse_loss_val
